...
export function WorkflowCanvas({ workflow }: { workflow: Workflow | null }) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {workflow ? (
              <div className="flex items-center gap-0 pl-24 pt-[20vh]">
                {workflow.nodes.map((node, i) => {
                  const isGroupActive =
                    selectedNodeId === node.id ||
                    (node.children?.some((c) => c.id === selectedNodeId) ?? false)
                    ...
                    <div key={node.id} className="flex items-center">
                      ...
                      <AgentNode
                        ...
                        onChildClick={(childId) =>
                          setSelectedNodeId(
                            selectedNodeId === childId ? null : childId,
                          )
                        }
                      />
                    </div>
              ...
              <div className="flex h-screen w-full items-center justify-center">
                <div className="flex flex-col items-center gap-3 text-center">
                  ...
                  <p className="max-w-xs text-sm text-zinc-600">
                    Create a new workflow to start processing video data through
                    the pipeline.
                  </p>
                </div>
              </div>
